  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<table border="1">
			...
			<?php 
				include 'koneksi.php';
				$no = 1;
				$data = mysqli_query($koneksi,"select * from bukti_transfer");
				while($d = mysqli_fetch_array($data)){
					...
					<tr>
						...
						<td>
							<a href="#?id=<?php echo $d['id']; ?>">ACC</a>
							<a href="tolakacc.php?id=<?php echo $d['id']; ?>">TOLAK</a>
						</td>
					</tr>
				<?php } ?>
	</table></center>
